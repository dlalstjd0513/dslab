...
{
    public class graphicsObject : HUD //graphicsObject 클래스는 HUD 클래스의 상속을 받음
    {


        private Bitmap bitmap; // 비트맵 이미지를 저장하는 변수

        public Bitmap Bitmap //비트맵 객체를 외부에서  읽을 수 있도록 제공하는 읽기 전용 속성
        {
            get
            {
                return bitmap;
        ...
        protected override void OnPaint(PaintEventArgs e) //화면에 hud데이터를 그리기 위한 메서드, 비트맵을 생성하고 그래픽을 렌더링
        {

            opengl = false; //opengl 비활성화
        ...
        private void InitializeComponent() //클래스의 기본 속성 및 초기 상태를 설정, 주로 UI 구성 요소의 초기화에 사용
        {
            this.SuspendLayout();
            // 
            // graphicsObject
            ...
            this.Size = new System.Drawing.Size(914, 572);
            this.VSync = false;
    ...
    public class HUD : GLControl
    {
        ...
        private static int UpLinkPort = 30000;
        private static int DownLinkPort = 40000;

        static byte[] reciveBuf; // VSM으로 부터 수신받은 데이터
        static Thread reciveT;
        static Thread StartVSM;
        static Thread StartHUD;

        private void graphicsObject_Load(object sender, EventArgs e)
        {
            //StartVSM = new Thread(VSM_Start);
            //reciveT = new Thread(recive);
            // StartVSM.Start();

            Console.WriteLine("load____________________-1");
        }
        static HUD()
        {
        ...
        public HUD()
        {
            ...
            Console.WriteLine("____________________loading____________________");
        ...
        public float roll
        {
            ...
            set
            {
                if (_roll != value)
                {
                    Debug.WriteLine($"[Write] Roll={_roll} -> {value}, Thread={Thread.CurrentThread.ManagedThreadId}");
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float pitch //hud의 pitch값을 관리(프로퍼티) ->HUD에서 데이터를 업데이트하는 표준 인터페이스
        {
            get { return _pitch; } //pitch값 반환
            set //외부에서 전달받은 새로운 pitch값(value)이 기존 값(_pitch)과 다를 경우
            {
                if (_pitch != value)
                {
                    _pitch = value; //새로운 pitch값 저장
                    this.Invalidate(); //hud 다시 그리기 요청
                }
            }
        }
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float groundspeed //지상속도 u_speed?
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float batterylevel //현재 전압 수준(volt)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float batterylevel2 //두번째 배터리 전압 수준(volt)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float batteryremaining2//두번째 배터리 남은 용량(percent)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float current2 //두번째 배터리 현재 전류 상태(ampere)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public int batterycellcount //배터리 셀 개수(cell)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float batteryremaining //남은 배터리 용량 비율(percent)
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float current //배터리 현재 전류 상태(ampere)
        {
            get { return _current; }
            set
            {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float gpshdop //gps 수평 위치
        {
            get { return _gpshdop; }
            set
            {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float gpsfix2 //두번째 수신기 위치 고정 상태
        {
            get { return _gpsfix2; }
            set
            {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float gpshdop2 //두번째 수평위치
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float disttowp //현재 비행기와 웨이포인트 사이 거리
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float groundcourse //지면 경로 각도
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float xtrack_error //경로 편차 오차
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float verticalspeed //수직 속도 w_speed?
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float linkqualitygcs //gcs 연결 품질
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public DateTime datetime //현재 시간
        {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float AOA //받음각 (angle of attack)
        {
            get { return _AOA; }
            set
            {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float critAOA //위험 aoa 임계값
        {
            get { return _critAOA; }
            set
            {
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float critSSA //위험 ssa임계값
        {
            get { return _critSSA; }
            set
            {
        ...
        public override void Refresh() //hud를 다시 그리도록 트리거
        {
            if (!ThisReallyVisible()) //ThisReallyVisible()는 HUD가 실제로 화면에 보이는 상태인지 확인
            {
                //  return;
            }
            ...
            //base.Refresh();
            using (Graphics gg = this.CreateGraphics()) //그래픽을 그릴 수 있는 graphics객체 생성
            {
                Console.WriteLine("Refresh()실행");
                OnPaint(new PaintEventArgs(gg, this.ClientRectangle)); //onpoint를 호출하여 HUD 강제로 다시 그림
        ...
        /// </summary>
        public new void Invalidate() //이 함수로 hud 그리게 함
        {
            if (HoldInvalidation)
                return;
        ...
        protected override void OnPaint(PaintEventArgs e) //그리기 동작을 제어하는 ㅁ[서드
        {
            ...
            if (this.DesignMode)
            {
                e.Graphics.Clear(this.BackColor); //graphics 객체를 사용하여 배경 초기화
                e.Graphics.Flush();
                opengl = false;
                doPaint(); //dopaint()로 그림을 그림
                //doPaint_STANAG();
            ...
            if (!started) //hud가 시작되지 않는 경우 아무 작업도 하지 않고 반환
                return;
            ...
            lock (this)
            {
                ...
                if (inOnPaint) //Onpaint()가 이미 실행중인 경우 호출 방지
                {
        ...
        public void RotateTransform(float angle) // 각도 변화
        {
            if (opengl)
            {
        ...
        public void VSM_Start()//메인 ㅋㅋ
        {
            ...
            reciveT.Start(); // reciveT 쓰레드 시작 (recive() 실행)

            Thread.Sleep(10000); // 수신 준비 대기 시간

            watch.Stop();
            Console.WriteLine($"[수신 준비 시간]: {watch.ElapsedMilliseconds} ms");
            ...
            while (true)
            {
                ...
                // 수신 시작 시간 측정
                var receiveWatch = System.Diagnostics.Stopwatch.StartNew();
                uint[] revBuf = Decoder(reciveBuf);
                receiveWatch.Stop();
                Console.WriteLine($"[메시지 수신 시간]: {receiveWatch.ElapsedMilliseconds} ms");
                ...
                long memoryBeforeProcessing = GC.GetTotalMemory(true);

                // 데이터 처리 시작 시간 측정
                var processingWatch = System.Diagnostics.Stopwatch.StartNew();

                foreach (uint rev in revBuf)
                {
                ...
                if (revBuf[6] == 4000)
                {
                    Console.WriteLine(revBuf[6] + " 자세 메시지");
                    _roll = (float)(UintToDouble(revBuf[11]) * ((2 * Math.PI) / 65536));
                    _pitch = (float)(UintToDouble(revBuf[12]) * ((2 * Math.PI) / 65536));
                    _heading = (float)(UintToDouble(revBuf[13]) * ((2 * Math.PI) / 65536));

                    Console.WriteLine($"Roll: {_roll}, Pitch: {_pitch}, Heading: {_heading}");
                }

                if (revBuf[6] == 4002)
                {
                    Console.WriteLine(revBuf[6] + " 위치 메시지");
                    _alt = (float)(UintToDouble(revBuf[13])) * 1000;
                    Console.WriteLine($"alt: {_alt}");
                }

                if (revBuf[6] == 4003)
                {
                    Console.WriteLine(revBuf[6] + " 속도 메시지");
                    _groundspeed = (float)(UintToDouble(revBuf[11])) * 100;
                    _airspeed = (float)(UintToDouble(revBuf[12])) * 100;
                    _verticalspeed = (float)(UintToDouble(revBuf[13])) * 100;

                    Console.WriteLine($"groundspeed: {_groundspeed}, airspeed: {_airspeed}, verticalspeed: {_verticalspeed}");
                }

                if (revBuf[6] == 12101)
                {
                    Console.WriteLine(revBuf[6] + " 배터리 메시지");
                    _current = (float)(UintToDouble(revBuf[12]) / 0.9);
                    _batterylevel = (float)(UintToDouble(revBuf[13]) / 1.05);
                    Console.WriteLine($"current: {_current}, batterylevel: {_batterylevel}");
                }

                Refresh(); // HUD 업데이트

                processingWatch.Stop();
                Console.WriteLine($"[데이터 처리 시간]: {processingWatch.ElapsedMilliseconds} ms");

                long memoryAfterProcessing = GC.GetTotalMemory(false);
                Console.WriteLine($"[데이터 처리 메모리 사용량]: {(memoryAfterProcessing - memoryBeforeProcessing) / 1024.0} KB");

                // 전체 종료 시간 및 메모리 사용량 계산
                watch.Stop();
                long totalMemoryAfter = GC.GetTotalMemory(false);
                Console.WriteLine($"[전체 소요 시간]: {watch.ElapsedMilliseconds} ms");
                Console.WriteLine($"[전체 메모리 사용량]: {(totalMemoryAfter - totalMemoryBefore) / 1024.0} KB\n");

                Thread.Sleep(2000); // 매 2초마다 반복
            }
        }

        public uint[] Decoder(byte[] _reciveBuf) // UDP로 수신된 바이트 배열을 uint 배열로 변환
        {
            if (_reciveBuf == null) return null;
        ...
        private static void recive() // VSM으로부터 패킷을 수신
        {
            if (client != null)
            {
            ...
            endPoint = new IPEndPoint(IPAddress.Any, 1006);

            client.Client.Bind(endPoint); // 특정 IP에 수신 시 bind 사용

            while (true)
            {
                if (client == null)
                {
                    return; // 클라이언트가 null이면 메서드 종료
                }
                ...
                try
                {
                    ...
                    watch.Stop();
                    Console.WriteLine($"[수신 대기 시간]: {watch.ElapsedMilliseconds} ms");
                    Console.WriteLine("Receive하는 중...");
                }
                catch (Exception ex)
                {
        ...
        private double UintToDouble(uint value) // uint 값을 부호 있는 double 값으로 변환
        {
            bool isNegative = (value & 0x80000000) != 0;
            uint actualvalue = value & 0x7FFFFFFF;
        ...
        private void send(byte[] buf) // VSM으로 패킷을 전송 ( 지금은 필요 없음)
        {
            ...
            try
            {
                using (UdpClient Server = new UdpClient())
                {
                    ...
                    IPEndPoint endPoint = new IPEndPoint(IPAddress.Parse("172.30.1.72"), UpLinkPort); //192.168.0.28
        ...
        internal void doPaint()// 가라칠부분..
        {
            ...
            try
            {
                ...
                // 데이터 유효성 검사
                if (float.IsNaN(_roll) || float.IsNaN(_pitch) || float.IsNaN(_heading)) //해당 값들이 숫자가 아닌경우(NaN), 이를 0으로 초기화하여 오류 방지
                {
                    isNaN = true;
                    Console.WriteLine("roll, pitch, heading값이 숫자가 아닌 경우입니다.");
                    _roll = 0;
                    _pitch = 0;
                    _heading = 0;
                }
                ...
                if (displayrollpitch) //롤 피치 화면 ㅋ
                {
                    ...
                    graphicsObject.RotateTransform(-roll); //이 부분 수정함 -roll
                    ...
                    int[] array = new int[] { -60, -45, -30, -20, -10, 0, 10, 20, 30, 45, 60 }; //roll 눈금 표시
        ...
        private float _load;
        public int cnt;
        private object bindingSourceQuickTab;
        ...
        public void doPaint_STANAG()//수정부분
        {
            int c = 10;
            _roll = 10 + c;
            c++;
            ...
            /* _pitch = buf;
             _roll = buf;
             _heading = buf;*/
            //Console.WriteLine("여긴 HUD이다.!!!!!!!!!!!!!!!!!!1");
            /*_alt = 0;
            _airspeed = 0;
            _batterylevel = (float)24.4;
            _current = 20;
            _batteryremaining = 100;
            criticalvoltagealert = false;*/
